    ...
    function carregaDicionario() {
       ...
       for (var bio in biografas){
        content.innerHTML += '<div class="card">' + '<img src="' + biografias[bio].imagem + '"/>' + '<details>' + '<summary>' + biografias[bio].nome + '</summary>' + '</details>' + '</div>' ;


        
       console.log((bio += " " + "Nome: " + biografias [bio].nome + " " + "Minibio: " + biografias [bio].descricao + " " + "Citacao: " + biografias [bio].citacao)
       );
       }
